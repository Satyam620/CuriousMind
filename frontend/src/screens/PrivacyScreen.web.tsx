...
const PrivacyScreenWeb: React.FC<Props> = ({ navigation }) => {
  ...
  React.useEffect(() => {
    if (typeof document !== 'undefined') {
      const styleId = 'privacy-scrollbar-styles';
      ...
      style.id = styleId;
      style.textContent = `
        .privacy-custom-scrollbar::-webkit-scrollbar {
          width: 8px;
        }
        .privacy-custom-scrollbar::-webkit-scrollbar-track {
          background: ${theme.isDark ? '#1F2937' : '#F8FAFC'};
          border-radius: 4px;
        }
        .privacy-custom-scrollbar::-webkit-scrollbar-thumb {
          background: ${theme.isDark ? '#4B5563' : '#CBD5E1'};
          border-radius: 4px;
          transition: background-color 0.2s ease;
        }
        .privacy-custom-scrollbar::-webkit-scrollbar-thumb:hover {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      className="privacy-custom-scrollbar"
      >
        {/* Header */}
